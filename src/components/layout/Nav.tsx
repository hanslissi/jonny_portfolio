  ...
  return (
    <header className="fixed w-full flex justify-center pt-6 top-0 z-50">
      <nav className="relative container mx-auto">
        ...
        <ul className="absolute top-0 left-1/2 -translate-x-1/2 bg-brightSecondaryBg backdrop-blur-md border-[0.5px] rounded-full flex flex-row justify-center items-center px-1 py-1 gap-2">
          <Link
            to="/#home"
            className="px-4 py-1 rounded-full text-nowrap hover:bg-whiteHighlight"
          >
            Home
          </Link>
          <Link
