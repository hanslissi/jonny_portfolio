...
const FilterDropdown = ({
  ...
  return (
    <div className="relative z-10">
      ...
      >
        <img src={imgArrowDownIcon} alt="Arrow down icon" className="h-4" />
      ...
      {showDropdown && (
        <div className="absolute w-64 flex flex-row flex-wrap gap-2 left-0 top-[100%] glasscard-dark mt-2 p-2 md:p-4">
